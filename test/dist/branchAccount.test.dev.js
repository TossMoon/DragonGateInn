...
var accountManager = require('../accountManager/accountManager.js');
...
describe("branchAccount", function () {
  ...
  it("向账户存储库中添加一个新分店账户", function () {
    var branchAccountManager = new accountManager();
    ...
    expect(branchAccountManager.getOneAccountByUsername("test").getActiveBool()).toBe(true); //禁用账户
