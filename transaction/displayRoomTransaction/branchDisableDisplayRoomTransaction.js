 ...
 * 分店下架展示房间事务
 */
class branchDisableDisplayRoomTransaction extends branchDisplayRoomTransaction{
    constructor(){
        super();
    }
    ...
    execute(...args){
        ...
        args.forEach((item,index)=>{
            if(index>0){
                displayRoomManager.setOneDisplayRoomDisable(item);
                // 获取展示房间实例并更新数据库
        ...
        return this.packageResult(true,null,"展示房间下架成功");
    }
}

module.exports=branchDisableDisplayRoomTransaction;