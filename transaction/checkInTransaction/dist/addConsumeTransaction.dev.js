...
var addConsumeTransaction =
/*#__PURE__*/
function (_transaction) {
  _inherits(addConsumeTransaction, _transaction);

  function addConsumeTransaction() {
    _classCallCheck(this, addConsumeTransaction);

    return _possibleConstructorReturn(this, _getPrototypeOf(addConsumeTransaction).call(this));
  }
  /**
  * 执行添加消费
  ...
  */
  ...
  _createClass(addConsumeTransaction, [{
    key: "execute",
    value: function execute() {
      ...
      (_get2 = _get(_getPrototypeOf(addConsumeTransaction.prototype), "execute", this)).call.apply(_get2, [this].concat(args));

      assert(args.length == 2, "参数数量错误");
      var checkInId = args[0];
      var consume = args[1];
